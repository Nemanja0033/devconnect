"use client"
import { CheckCircle2Icon, CircleCheck, Image } from "lucide-react"
  ...
  if(isPosted){
    return(
        <div className="w-full h-screen flex justify-center lg:px-40 px-5">
            <section className="flex-row lg:w-1/2 w-full">
                <h1 className="text-3xl font-semibold text-purple-900">Posted Successfully!</h1>
                <Link className="bg-purple-800 hover:bg-purple-900 transition-all rounded-2xl p-2 text-white font-semibold cursor-pointer" href={"/"}>Home</Link>
            </section>
        </div>
    )
  }
