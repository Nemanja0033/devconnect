  ...
  return (
    <div className="flex flex-col items-center space-y-4">
      ...
      <section className="md:w-[1000px] h-105 shadow-md border-2 dark:bg-accent mt-2 rounded-md relative">
        <Skeleton className="md:h-52 w-full rounded-md md:w-[999px] absolute" />
        <div className="relative left-0 top-32 flex flex-col items-center space-y-4">
          <Skeleton className="rounded-full absolute left-0 border-gray-500 border-3 w-52 h-52" />
          <div className="px-5 grid w-full space-y-2">
            <div className="flex justify-between items-center">
              <Skeleton className="w-40 h-6 opacity-90" />
              <Skeleton className="w-6 h-6 opacity-90" />
            </div>
