import { avatarPlaceholdedr, coverPlaceholder } from '@/constants/constants'
  ...
  return (
    <section className="lg:w-[1000px] w-full h-32  shadow-md border-2 dark:bg-accent mt-2 rounded-md">
            <div className="relative bottom-40">
                <img onClick={isMyProfile ? openAvatarEdit : () =>{}} src={user?.avatar ?? avatarPlaceholdedr} className="rounded-full border-4 border-accent shadow-indigo-950 shadow-lg w-52 h-52 cursor-pointer" alt="" />
